...
Each image is analyzed using a python program in order to extract main colors of each image and then visualized using either html or a Processing custom tool. 
